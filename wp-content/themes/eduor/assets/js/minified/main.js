(function ($) {
    ...
    /*-- eduor scroll top scripts start --*/
    var eduorScrollTop = document.querySelector(".eduor-scroll-top");
    if (eduorScrollTop != null) {
        var scrollProgressPatch = document.querySelector(".eduor-scroll-top path");
        ...
        window.addEventListener("scroll", function (event) {
            ...
            if (scrollElementPos >= offset) {
                eduorScrollTop.classList.add("progress-done");
            } else {
                eduorScrollTop.classList.remove("progress-done");
            }
        });
        eduorScrollTop.addEventListener("click", function (e) {
            e.preventDefault();
            window.scroll({
                top: 0,
                left: 0,
    ...
    if (servicesSelect.length) {
        ...
        create a new DIV that will act as an option item:*/
                ...
                c.addEventListener("click", function (e) {
                    /*when an item is clicked, usc_post_date the original select box,
