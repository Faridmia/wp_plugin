...
<div class="lp-courses-bar <?php echo esc_attr($active); ?>">
	...
	<div class="switch-layout">
		<div class="course-index">
			<span><?php eduor_lp_the_course_indexing_text($wp_query->found_posts); ?></span>
		</div>
		<?php foreach ($layouts as $layout => $value) : ?>
			...
			<label class="switch-btn <?php echo esc_attr($layout); ?>" title="<?php echo sprintf(esc_attr__('Switch to %s', 'learnpress'), $layout); ?>" for="lp-switch-layout-btn-<?php echo esc_attr($layout); ?>"></label>
		<?php endforeach; ?>
	</div>
</div>