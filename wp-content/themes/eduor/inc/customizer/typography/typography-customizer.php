 ...
 * @version 1.0
 */
namespace SoftCoders\eduor\Customizer\Typography;
    ...
    * ========================================================================================*/
	public function register_typography_sections( $wp_customize ) {
		...
		$wp_customize->add_section( 'typography_heading_section',
			array(
				'title' => esc_html__( 'Heading', 'eduor' ),
				'priority' => 3,
				'panel' => 'softcoderstheme_typography_defaults',
			)
		);
	...
	* ========================================================================================*/
	public function register_typography_controls( $wp_customize ) {
		...
		$wp_customize->add_control( 'typo_body_size',
			array(
				'label' => esc_html__( 'Font Size', 'eduor' ),
				'description' => esc_html__( 'Font Size (px)', 'eduor' ),
				'section' => 'typography_body_section',
				'type' => 'text',
				'input_attrs' => array(
					'class' => 'rtt-txt-box',				
		...
		$wp_customize->add_control( 'typo_body_height',
			array(
				'label' => esc_html__( 'Line Height', 'eduor' ),
				'description' => esc_html__( 'Line Height (px)', 'eduor' ),
				'section' => 'typography_body_section',
				'type' => 'text',
				'input_attrs' => array(
					'class' => 'rtt-txt-box',					
		...
		$wp_customize->add_control( 'typo_submenu_size',
			array(
				'label' => esc_html__( 'Sub Menu Font Size', 'eduor' ),
				'description' => esc_html__( 'Font Size (px)', 'eduor' ),
				'section' => 'typography_menu_section',
				'type' => 'text',
				'input_attrs' => array(
		...
		$wp_customize->add_control( 'typo_submenu_height',
			array(
				'label' => esc_html__( 'Sub Menu Line Height', 'eduor' ),
				'description' => esc_html__( 'Line Height (px)', 'eduor' ),
				'section' => 'typography_menu_section',
				'type' => 'text',
				'input_attrs' => array(
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_heading',
			array(
				'label' => esc_html__( 'All Heading Typography (H1-H6)', 'eduor' ),
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h1',
			array(
				'label' => esc_html__( 'Header h1 ', 'eduor' ),
				'section' => 'typography_heading_section',
				'input_attrs' => array(
					'font_count' => 'all',
					'orderby' => 'popular',
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h2',
			array(
				'label' => esc_html__( 'Header h2 ', 'eduor' ),
				'section' => 'typography_heading_section',
				'input_attrs' => array(
					'font_count' => 'all',
					'orderby' => 'popular',
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h3',
			array(
				'label' => esc_html__( 'Header h3 ', 'eduor' ),
				'section' => 'typography_heading_section',
				'input_attrs' => array(
					'font_count' => 'all',
					'orderby' => 'popular',
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h4',
			array(
				'label' => esc_html__( 'Header h4 ', 'eduor' ),
				'section' => 'typography_heading_section',
				'input_attrs' => array(
					'font_count' => 'all',
					'orderby' => 'popular',
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h5',
			array(
				'label' => esc_html__( 'Header h5 ', 'eduor' ),
				'section' => 'typography_heading_section',
				'input_attrs' => array(
					'font_count' => 'all',
					'orderby' => 'popular',
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_h6',
			array(
				'label' => esc_html__( 'Header h6 ', 'eduor' ),
				'section' => 'typography_heading_section',
				'input_attrs' => array(
					'font_count' => 'all',
					'orderby' => 'popular',
