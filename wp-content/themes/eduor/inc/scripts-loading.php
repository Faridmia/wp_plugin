	...
	private function template_style()
	{
		...
		if (is_single()) {
			if (!empty(eduor::$bgimg)) {
				...
				$style .= '.single .sc-breadcrumb-section { background-image: url(' . eduor::$bgimg . ')}';
				$style .= '.single .sc-breadcrumb-section:before { background-color: ' . eduor::$bgcolor . '}';
			...
			if (!empty(eduor::$bgimg)) {
				$opacity = eduor::$opacity / 100;
				$style .= '.sc-breadcrumb-section { background-image: url(' . eduor::$bgimg . ')}';
				$style .= '.sc-breadcrumb-section:before { background-color: ' . eduor::$bgcolor . '}';
				$style .= '.sc-breadcrumb-section:before { opacity: ' . $opacity . '}';
			} else {
				$opacity = eduor::$opacity / 100;
				$style .= '.sc-breadcrumb-section:before { background-color: ' . eduor::$bgcolor . '}';
		...
		if (eduor::$padding_top) {
			$style .= '.sc-breadcrumb-section { padding-top:' . eduor::$padding_top . 'px;}';
		}
		if (eduor::$padding_bottom) {
			$style .= '.sc-breadcrumb-section { padding-bottom:' . eduor::$padding_bottom . 'px;}';
		}

		/* Page gap
        =======================================================*/

		// if ( eduor::$page_padding_top) {
		// 	$style .= '.sc-page-gap { padding-top:'. eduor::$page_padding_top . 'px;}';
		// }
		// if ( eduor::$page_padding_bottom) {
		// 	$style .= '.sc-page-gap { padding-bottom:'. eduor::$page_padding_bottom . 'px;}';
		// }
