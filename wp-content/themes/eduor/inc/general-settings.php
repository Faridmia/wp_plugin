...
class General_Setup
{
	...
	public function __construct()
	{
		...
		add_filter('upload_mimes', 						   array($this, 'eduor_custom_mime_types'));
	}
	...
	public function register_sidebars()
	{
		register_sidebar(array(
			'name'          => esc_html__('Blog Widgets', 'eduor'),
			'id'            => 'sidebar',
			'description'   => esc_html__('Add widgets here.', 'eduor'),
			'before_widget' => '<div id="%1$s" class="widget-area sc-mb-30 %2$s sidebar-widget ">',
			'after_widget'  => '</div>',
	...
	public function search_form()
	{
		...
		<div class="sc-searchbar-area p-z-idex">
			<form role="search" method="get" class="search-form" action="' . esc_url(home_url('/')) . '">
				<input type="text" class="form-control" placeholder="' . esc_attr__('Search here ...', 'eduor') . '" value="' . get_search_query() . '" name="s" />
				<button type="submit"><i class="icon-search default-icon" aria-hidden="true"></i></button>
			</form>
		</div>
	...
	public function eduor_custom_mime_types($mimes)
	{
